...
void lcdInit(void)
{
	// prepare setting for MemoryAccessControlConfig
	...
	// Power Control B
	lcdWriteCommand(ILI9341_POWERB);
	lcdWriteData(0x00);
	lcdWriteData(0x83);
	lcdWriteData(0x30);

	// Power on Sequence control
	lcdWriteCommand(ILI9341_POWER_SEQ);
	lcdWriteData(0x64);
	lcdWriteData(0x03);
	lcdWriteData(0x12);
	lcdWriteData(0x81);
	...
	lcdWriteCommand(ILI9341_DTCA);
	lcdWriteData(0x85);
	lcdWriteData(0x01);
	lcdWriteData(0x79);

	// Power Control A
	lcdWriteCommand(ILI9341_POWERA);
	lcdWriteData(0x39);
	lcdWriteData(0x2C);
	lcdWriteData(0x00);
	lcdWriteData(0x34);
	...
	// Pump ratio control
	lcdWriteCommand(ILI9341_PRC);
	lcdWriteData(0x20);

	// Driver timing control B
	lcdWriteCommand(ILI9341_DTCB);
	lcdWriteData(0x00);
	lcdWriteData(0x00);
	...
	// Enable 3 GAMMA
	lcdWriteCommand(ILI9341_3GAMMA_EN);
	lcdWriteData(0x08);
